			        			...
			        			<td>
									...
									<?php $__currentLoopData = $iposFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iposFeature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<li>
											...
											<?php echo $__env->make('helpers.viewBool', ['value' => (isset($group->ipos_settings[$iposFeature->id]) && $group->ipos_settings[$iposFeature->id])], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
										</li>
