...
<html lang="<?php echo e(config('app.locale')); ?>">
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o enable-page-overlay sidebar-dark side-scroll page-header-fixed">
            ...
            <nav id="sidebar" aria-label="Main Navigation">
                    ...
                    <div>
                        ...
                        <div class="dropdown d-inline-block ml-3">
                            ...
                            <div class="dropdown-menu dropdown-menu-right font-size-sm smini-hide border-0" aria-labelledby="sidebar-themes-dropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?php echo e(asset('css/themes/amethyst.css')); ?>" href="#">
                                    <span>Amethyst</span>
                                    <i class="fa fa-circle text-amethyst"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?php echo e(asset('css/themes/city.css')); ?>" href="#">
                                    <span>City</span>
                                    <i class="fa fa-circle text-city"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?php echo e(asset('css/themes/flat.css')); ?>" href="#">
                                    <span>Flat</span>
                                    <i class="fa fa-circle text-flat"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?php echo e(asset('css/themes/modern.css')); ?>" href="#">
                                    <span>Modern</span>
                                    <i class="fa fa-circle text-modern"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?php echo e(asset('css/themes/smooth.css')); ?>" href="#">
                                    <span>Smooth</span>
                ...
                <div class="content-side content-side-full">
                	<?php echo $__env->make('layouts.backendMainMenu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <!-- END Side Navigation -->
            </nav>
            <!-- END Sidebar -->
		...
		<?php echo $__env->make('helpers.notification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
