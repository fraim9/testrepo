...
return [
    ...
    */
    ...
    'default' => env('DB_DEFAULT', 'omnipos'),
    ...
    */
    ...
    'connections' => [
        ...
        'omnipos' => [
            'driver' => 'mysql',
            'host' => env('DB_OMNIPOS_HOST', '127.0.0.1'),
            'port' => env('DB_OMNIPOS_PORT', '3306'),
            'database' => env('DB_OMNIPOS_DATABASE', 'forge'),
            'username' => env('DB_OMNIPOS_USERNAME', 'forge'),
            'password' => env('DB_OMNIPOS_PASSWORD', ''),
